...
piano_color1 db 12 ; light color of the piano pallet
piano_color2 db 4 ; dark color of the piano palet
key_color1 db 11 ; light color in a key after its pressed
key_color2 db 9  ; dark color in a key after its pressed
...
start:
mov ah, 0 ;Thiago stuff
mov al, 13h ;Thiago stuff
int 10h ;Thiago stuff
